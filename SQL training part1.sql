...
-- A table(is identified by a name) is a collection of data that is organized into rows(records) and columns(fields).
...
use store; -- to selecvt the database(ctrl+Enter to run)
